 ...
 */
package Output.ListView.ScrollView;
...
public class MovieScrollPanel extends javax.swing.JPanel {
    ...
    public MovieScrollPanel(int size, int threadSize, Scroll type, SearchMovies sm) {
        switch(type)
        {
            case GRID->
            {
                initComponents(new Output.ListView.GridView.MovieGridPanel(size, threadSize, sm));
            ...
            case LINEAR -> {
                initComponents(new Output.ListView.LinearView.MovieLinearPanel(20, 4, sm));
