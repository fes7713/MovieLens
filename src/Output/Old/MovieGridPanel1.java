 ...
 * @author fes77
 */
public class MovieGridPanel1 extends javax.swing.JPanel implements SearchMovies{
...
//            executor.execute(new MovieCardProducer(addingMovies.get(i), movies, (MovieGridPanel)this, true));
